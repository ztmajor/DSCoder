...
'./languages/xml': function (module, exports, require) {
/*
Language: HTML, XML
...
'./languages/bash': function (module, exports, require) {
/*
Language: Bash
...
'./languages/c': function (module, exports, require) {
/*
Language: C
...
'./languages/cpp': function (module, exports, require) {
/*
Language: C++
Category: common, system
...
'./languages/csharp': function (module, exports, require) {
/*
Language: C#
...
'./languages/css': function (module, exports, require) {
const MODES = (hljs) => {
  return {
    IMPORTANT: {
      scope: 'meta',
...
'./languages/markdown': function (module, exports, require) {
/*
Language: Markdown
Requires: xml.js
...
'./languages/diff': function (module, exports, require) {
/*
Language: Diff
...
'./languages/ruby': function (module, exports, require) {
/*
Language: Ruby
...
'./languages/go': function (module, exports, require) {
/*
Language: Go
...
'./languages/graphql': function (module, exports, require) {
/*
 Language: GraphQL
...
'./languages/ini': function (module, exports, require) {
/*
...
'./languages/java': function (module, exports, require) {
...
'./languages/javascript': function (module, exports, require) {
...
'./languages/json': function (module, exports, require) {
...
'./languages/kotlin': function (module, exports, require) {
// https://docs.oracle.com/javase/specs/jls/se15/html/jls-3.html#jls-3.10
var decimalDigits = '[0-9](_*[0-9])*';
var frac = `\\.(${decimalDigits})`;
var hexDigits = '[0-9a-fA-F](_*[0-9a-fA-F])*';
...
'./languages/less': function (module, exports, require) {
const MODES = (hljs) => {
  return {
    IMPORTANT: {
      scope: 'meta',
...
'./languages/lua': function (module, exports, require) {
/*
Language: Lua
...
'./languages/makefile': function (module, exports, require) {
/*
Language: Makefile
...
'./languages/perl': function (module, exports, require) {
/*
Language: Perl
...
'./languages/objectivec': function (module, exports, require) {
/*
...
'./languages/php': function (module, exports, require) {
/*
Language: PHP
...
'./languages/php-template': function (module, exports, require) {
/*
...
'./languages/plaintext': function (module, exports, require) {
/*
Language: Plain text
...
'./languages/python': function (module, exports, require) {
/*
Language: Python
...
'./languages/python-repl': function (module, exports, require) {
/*
...
'./languages/r': function (module, exports, require) {
/*
Language: R
...
'./languages/rust': function (module, exports, require) {
/*
Language: Rust
...
'./languages/scss': function (module, exports, require) {
const MODES = (hljs) => {
  return {
    IMPORTANT: {
      scope: 'meta',
...
'./languages/shell': function (module, exports, require) {
/*
...
'./languages/sql': function (module, exports, require) {
/*
 Language: SQL
...
'./languages/swift': function (module, exports, require) {
/**
 * @param {string} value
 * @returns {RegExp}
 * */
...
'./languages/yaml': function (module, exports, require) {
/*
Language: YAML
...
'./languages/typescript': function (module, exports, require) {
const IDENT_RE = '[A-Za-z$_][0-9A-Za-z$_]*';
...
'./languages/vbnet': function (module, exports, require) {
/*
...
'./languages/wasm': function (module, exports, require) {
/*
...
// dsh-idelike（文件树 + 标签页 + 终端插件）— client half（静态 bundle 形态）
// - rpc(method, args) → fetch POST /_dsh/dsh-idelike/<method>（JSON）
...
const RPC_BASE = '/_dsh/dsh-idelike';
...
function installStyles() {
  const id = 'dsh-idelike';
  const existing = document.querySelector('style[data-plugin-css="' + id + '"]');
  if (existing !== null) return function () {};
  const style = document.createElement('style');
  style.dataset.plugin = 'dsh-idelike';
...
module.exports = {
  async apply(ctx) {
    ...
    if (slots === undefined) {
      console.warn('[dsh-idelike] slots 服务 18s 内未就绪，插件未注册');
      return;
    }
    ...
    function DscoderWorkspace(props) {
      ...
      function pickRootDir() {
        ...
        if (!ws || typeof ws.pickDirectory !== 'function') {
          console.warn('[dsh-idelike] workspaces.pickDirectory 不可用');
          return;
        }
        ws.pickDirectory().then(function (path) {
          if (path) { setTreeRoot(path); setTreeOpen(true); }
        }).catch(function (err) {
          console.warn('[dsh-idelike] 选择目录失败', String((err && err.message) || err));
        });
      }
    ...
    function applyMode() {
      ...
      dispose = slots.register(
        { name: 'shell.overlay', id: 'dsh-idelike', order: 0, label: 'DSCoder 文件树与标签页' },
        function (slotProps) {
