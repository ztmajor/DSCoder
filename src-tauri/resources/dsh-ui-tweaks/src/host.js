...
const ALL_FIELDS = ['fontSize', 'codeFontSize', 'lineHeight', 'tableStyle', 'dialogWidth', 'timelineEnabled', 'bottomInfoBarEnabled', 'zoomInShortcut', 'zoomOutShortcut', 'uiOpacity']
...
function loadConfig() {
  try {
    ...
    if (typeof parsed.bottomInfoBarEnabled === 'boolean') out.bottomInfoBarEnabled = parsed.bottomInfoBarEnabled
...
export default {
  ...
  apply(ctx) {
    ...
    function rpcSetField(args) {
      ...
      } else if (field === 'bottomInfoBarEnabled') {
        config.bottomInfoBarEnabled = !!value
